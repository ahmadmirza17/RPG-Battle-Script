...
thunder = Spell("Thunder", 125, 600, "black")
...
hielixer = Item("Mega-Elixer", "elixer", "Fully restores part's HP/MP", 9999)
    ...
    for player in players:
        ...
        if index == 0:
            ...
            if item.type == "potion":
                ...
                print(bcolors.FAIL + "\n" + item.name + "deals", str(item.prop), "points of damage " + enemies[enemy].name + bcolors.ENDC)
